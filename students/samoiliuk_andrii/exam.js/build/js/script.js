...
jquery__WEBPACK_IMPORTED_MODULE_2___default()('.bgSlider').slick({
  infinite: true,
  slidesToShow: 1,
  slidesToScroll: 1,
  arrows: false,
...
jquery__WEBPACK_IMPORTED_MODULE_2___default()('.newsSlider').slick({
  infinite: true,
  slidesToShow: 3,
  slidesToScroll: 1,
  arrows: true,
...
function openSlides(event) {
  ...
  if (galleryButton.innerHTML === "see more") {
    ...
    galleryButton.innerHTML = "see more";
  }
  ;
