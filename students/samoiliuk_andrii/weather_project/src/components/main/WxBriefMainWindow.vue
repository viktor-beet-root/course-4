<template>
    ...
    >
        <h6 class="name">
            <span v-if="airport.flight_category === 'VFR'" class="category_vfr">
            ...
            <span v-if="airport.flight_category === 'IFR'" class="category_ifr">
                {{ airport.flight_category }}
            </span>
            <span
        ...
        <ul>
            <li>Pressure: {{ Math.round(airport.barometer.kpa * 10) }} hPa</li>
            <li>
                Clouds:
                <ul>
