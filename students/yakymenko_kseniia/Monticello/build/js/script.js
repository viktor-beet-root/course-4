...
function headerMenuNavigation() {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).on('scroll', function () {
        setTimeout(function () {
            if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).scrollTop() > 900 && !isSticky) {
                $header.addClass("header_fixed");
                isSticky = true;
            } else if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).scrollTop() < 880 && isSticky) {
...
setTimeout(function () {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.footer__logo-link').on('click', smothScroll);
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.header-section__scroll-link').on('click', smothScroll);
}, 0);
...
/* harmony default export */ __webpack_exports__["default"] = (headerMenuNavigation);
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).ready(function () {
        ...
        setTimeout(function () {
            $seeMore.on("click", function () {
                jquery__WEBPACK_IMPORTED_MODULE_0___default()('#morePhotos').before(htmlGalleryPhotos);
            });
        }, 0);
    });
...
function formValidationFooter() {
    ...
    let checkName = false;
    function validate2() {
        const $result2 = jquery__WEBPACK_IMPORTED_MODULE_0___default()("#result2");
        ...
        if (validateUser(userName)) {
            ...
            jquery__WEBPACK_IMPORTED_MODULE_0___default()('#userName').css("borderColor", "green");
            checkName = true;
        } else {
    ...
    const setAttribTrue = function setTrue() {
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('input[type="submit"]').prop('disabled', true);
    };
    const setAttribFalse = function setFalse() {
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('input[type="submit"]').prop('disabled', false);
    };

    let checkEmail = false;
    function validate() {
        const $result = jquery__WEBPACK_IMPORTED_MODULE_0___default()("#result");
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).ready(function () {
        let setNameColorRed = function setNameColorRedFunction() {
            ...
            jquery__WEBPACK_IMPORTED_MODULE_0___default()('#userName').css("borderColor", "red");
        }
        let setEmailColorRed = function setNameColorRedFunction() {
            jquery__WEBPACK_IMPORTED_MODULE_0___default()("#result").text('Input your email');
            jquery__WEBPACK_IMPORTED_MODULE_0___default()("#result").css("color", "red");
            jquery__WEBPACK_IMPORTED_MODULE_0___default()('#email').css("borderColor", "red");
            event.preventDefault();
        }
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('input[type="submit"]').on('click', function () {
            if (jquery__WEBPACK_IMPORTED_MODULE_0___default()("#userName").val().length === 0) {
                setNameColorRed();
                event.preventDefault();
            }
            if (jquery__WEBPACK_IMPORTED_MODULE_0___default()("#email").val().length === 0) {
                setEmailColorRed();
                event.preventDefault();
                return;
            }
...
/* harmony default export */ __webpack_exports__["default"] = (formValidationFooter);
