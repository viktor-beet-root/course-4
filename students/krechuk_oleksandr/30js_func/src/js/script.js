...
function length(...arg) {
    const argLeng = 'кількість переданих аргументів ' + arg.length;
    console.log(argLeng);
}
length(1, 5, 756, 345, 76, 134, 6574, 846, 134, 6435, 735);
...
function square(num1, num2 = num1) {
    const result = 'Площа квадрата ' + num1 * num2;
    console.log(result);
}
square(9, 5);
