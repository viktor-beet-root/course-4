<template>
    <div class="product mb-4">
        ...
        />
        <beetroot-button
            class="product__add-to-cart btn btn-primary w-100"
            text="Add To Cart"
            :disabled="!product.instock"
            @action="$emit('addToCart')"
        />
    </div>
</template>
...
export default {
    components: { BeetrootImage, BeetrootTitle, BeetrootPrice, BeetrootButton },
