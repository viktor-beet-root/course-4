...
/* harmony import */ var _shop_config__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./shop-config */ "./src/js/shop-config.js");
...
var cartConfig = {
  data: function data() {
    return {
      imagesPath: _shop_config__WEBPACK_IMPORTED_MODULE_6__["default"].imagesPath,
      currensySymbol: _shop_config__WEBPACK_IMPORTED_MODULE_6__["default"].currensySymbol,
      cartList: []
    };
  },
  methods: {
    setQty: function setQty(isIncl, product) {
    ...
    hasProductInCart: function hasProductInCart(productId) {
      return this.cartList.find(function (product) {
    ...
    getCartProductId: function getCartProductId() {
      var lastProductCart = this.cartList[this.cartList.length - 1];
      if (lastProductCart) {
    ...
    getTotalProductPrice: function getTotalProductPrice(product) {
      var price = 0;
  ...
  computed: {
    totalCart: function totalCart() {
      var _this = this;
      var priceList = this.cartList.map(function (product) {
        return _this.getTotalProductPrice(product);
      });
      if (priceList.length) return priceList.reduce(function (acc, curVal) {
        return acc + curVal;
      });else return 0;
    }
  },
...
var cartVm = vue_dist_vue_esm_browser__WEBPACK_IMPORTED_MODULE_5__.createApp(cartConfig).mount('#cart');
/* harmony default export */ __webpack_exports__["default"] = (cartVm);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _products__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./products */ "./src/js/products.js");
...
/* harmony import */ var _shop_config__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./shop-config */ "./src/js/shop-config.js");
...
var productConfig = {
  data: function data() {
    return {
      imagesPath: _shop_config__WEBPACK_IMPORTED_MODULE_3__["default"].imagesPath,
      currensySymbol: _shop_config__WEBPACK_IMPORTED_MODULE_3__["default"].currensySymbol,
      outOfStockMessage: _shop_config__WEBPACK_IMPORTED_MODULE_3__["default"].outOfStockMessage,
      products: _products__WEBPACK_IMPORTED_MODULE_0__["default"]
    };
  },
  methods: {
    addToCart: function addToCart(product) {
      var productInCart = _cart__WEBPACK_IMPORTED_MODULE_2__["default"].hasProductInCart(product.id);
      if (productInCart) {
        _cart__WEBPACK_IMPORTED_MODULE_2__["default"].setQty(true, productInCart);
      } else {
        _cart__WEBPACK_IMPORTED_MODULE_2__["default"].addToCart(product);
      }
    }
  }
};
var productVm = vue_dist_vue_esm_browser__WEBPACK_IMPORTED_MODULE_1__.createApp(productConfig).mount('#productList');

/***/ }),

/***/ "./src/js/shop-config.js":
/*!*******************************!*\
  !*** ./src/js/shop-config.js ***!
  \*******************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/******/ 	var __webpack_exports__ = __webpack_require__("./src/js/shop-config.js");
/******/ 	
/******/ })()
;
