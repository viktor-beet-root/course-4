...
var config = {
  ...
  computed: {
    ...
    buttonTextHtml: function buttonTextHtml() {
  ...
  methods: {
    getUserInfo: function getUserInfo() {
      console.log(1111);
      return "".concat(this.user.name, " ").concat(this.user.email);
    },
    setAge: function setAge(e) {
      var newAge = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 1;
      console.log(newAge);
