...
var app = vue_dist_vue_esm_browser__WEBPACK_IMPORTED_MODULE_0__.createApp(config);
...
var config = {
  ...
  computed: {
    confirmedPass: function confirmedPass() {
  ...
  methods: {
    ...
    isValidateForm: function isValidateForm() {
      var form = this.addUserForm;
      form.isValidate = true;
      return !!(form.firstName && form.lastName && form.userName && form.email && form.password && form.confirmPassword && this.confirmedPass);
    },
...
var userApp = vue_dist_vue_esm_browser__WEBPACK_IMPORTED_MODULE_1__.createApp(config);
var userVm = userApp.mount('#userList');
}();
/******/ })()
;
