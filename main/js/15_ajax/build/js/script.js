...
function myAjax(options, callback, data) {
  ...
  xhr.responseType = options.type ? options.type : 'json'; // xhr.onreadystatechange = () => {
  ...
  xhr.onprogress = function (e) {
    if (e.lengthComputable) {
      console.log("Loaded: ".concat(e.loaded, " to ").concat(e.total));
    } else {
      console.log("Loaded: ".concat(e.loaded));
    }
  };
...
/* harmony default export */ __webpack_exports__["default"] = (myAjaxPromis);
...
/* harmony import */ var _myAjax__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./myAjax */ "./src/js/myAjax.js");
/* harmony import */ var _myAxaxPromis__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./myAxaxPromis */ "./src/js/myAxaxPromis.js");
/* harmony import */ var _myFetch__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./myFetch */ "./src/js/myFetch.js");
...
var renderHtml = function renderHtml(data) {
  ...
  data.forEach(function (user) {
    var template = "\n        <li class=\"user-list__item\">\n            <strong>".concat(user.id, ". ").concat(user.name, "</strong>\n        </li>");
    userList.insertAdjacentHTML('beforebegin', template);
  });
};

(0,_myFetch__WEBPACK_IMPORTED_MODULE_8__["default"])(url).then(function (data) {
  console.log(data);
}); // myFetch(url, {
//     method: 'POST',
//     body: JSON.stringify({
...
/******/ 	__webpack_require__("./src/js/myAxaxPromis.js");
