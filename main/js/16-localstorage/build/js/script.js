...
function getCookie(nameCookie) {
  ...
  var cookieList = document.cookie.split('; ').map(function (item) {
    return item.split('=');
  });
  var cookie = Object.fromEntries(cookieList)[nameCookie];
...
function setCookie(nameCookie, value, options) {
  ...
  if (options) {
    for (var key in options) {
      ...
      if (key === 'expire' && _value instanceof Date) {
...
var counterElement = document.querySelector('.my-title > span');
var counterCookieName = 'counter';
var counterCookie = getCookie(counterCookieName);
var counter = 0;
if (counterCookie) {
...
var addForm = document.querySelector('.add-user');
var userListElement = document.querySelector('.user-list');
addForm.addEventListener('submit', function (e) {
  e.preventDefault();
  var user = Object.fromEntries(Array.from(new FormData(this)));
  renderUser(user);
  addUserToLocalStorage(user);
});
function renderUser(user) {
  var template = "<li>\n        User name: ".concat(user['user-name'], ";\n        email: <a href=\"mailto:").concat(user.email, "\">").concat(user.email, "</a>\n        age: ").concat(user.age, "\n    </li>");
